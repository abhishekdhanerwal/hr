...
(function () {
  ...
  HelperEditCtrl.$inject = [ 'NgTableParams', '$window', '$document', '$filter', 'helperFactory', '$state', 'validationHelperFactory', '$stateParams', 'toaster', 'role', '$scope', 'FileUploader', '$http', '$rootScope', 'SweetAlert'];
  /* @ngInject */
  function HelperEditCtrl( NgTableParams, $window, $document, $filter, helperFactory, $state, validationHelperFactory, $stateParams , toaster, role, $scope, FileUploader, $http, $rootScope, SweetAlert) {
    var vm = this;
