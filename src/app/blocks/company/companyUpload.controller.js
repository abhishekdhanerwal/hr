(function () {
    ...
    angular
      .module('blocks.auth')
      .controller('CompanyUploadController', CompanyUploadController);
  
      CompanyUploadController.$inject = ['$scope', '$state', 'ngNotify', '$filter', '$localStorage', 'validationHelperFactory'];
    /* @ngInject */
    function CompanyUploadController($scope, $state, ngNotify, $filter, $localStorage, validationHelperFactory) {
      var vm = this;
